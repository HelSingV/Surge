...
Surge:
[Script]
http-response https:\/\/api\.rr\.tv(\/user\/privilege\/list|\/ad\/getAll) requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/HelSingV/Surge/master/JavaScript/rrtv.js
[MITM]
hostname = *.rr.tv
*/
